...
export class LoginComponent implements OnInit {
  ...
  constructor(private storageAlbumnsService:StorageAlbumnsService,private albumnsService:AlbumnsService,private postsService:PostsService,private storagePostsService:StoragePostsService, private router:Router,private authService:AuthService,private userStatusService:UserStatusService,private _builder:FormBuilder) { 
  ...
  ngOnInit(): void {
    ...
    forkJoin([obsListPost$.subscribe(listP=>{
